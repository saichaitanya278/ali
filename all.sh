...
: ' virtualbox
paru -S git xf86-video-vmware neofetch sxiv pcmanfm nerd-fonts-mononoki file-roller mpv net-tools  xmonad xmonad-contrib xfce4-settings xdotool  alacritty  xmobar  trayer  nitrogen picom pcmanfm lxsession sxiv xfce4-power-manager  flameshot  volumeicon pavucontrol papirus-icon-theme  light exa otf-font-awesome-5-free htop iftop lxappearance dmenu materia-theme xfce4-clipman-plugin -y
...
'
: ' my host
paru -S xf86-video-amdgpu  xmonad xmonad-contrib xfce4-settings xdotool  alacritty  xmobar  trayer  nitrogen picom pcmanfm lxsession sxiv xfce4-power-manager  flameshot  volumeicon pavucontrol papirus-icon-theme  light exa otf-font-awesome-5-free htop iftop lxappearance dmenu materia-theme xfce4-clipman-plugin -y
